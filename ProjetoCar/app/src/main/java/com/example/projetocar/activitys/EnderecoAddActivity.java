...
import com.example.projetocar.api.CEPService;
...
public class EnderecoAddActivity extends AppCompatActivity {
    ...
    //Declarando componentes da activity_endereço
                    ...
                    if(response.isSuccessful()){
                        ...
                        if(endereco != null){
                            if(endereco.getLogradouro() != null){
                                ...
                                Toast.makeText(EnderecoAddActivity.this, "Não foi possivel recuperar o endereço", Toast.LENGTH_SHORT).show();
                            }
                        }else{
                            Toast.makeText(EnderecoAddActivity.this, "Não foi possivel recuperar o endereço", Toast.LENGTH_SHORT).show();
                        }
